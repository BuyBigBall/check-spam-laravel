...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        $userMetas = null; $value = null;$current_rate = null;$after_rate = null; 
        $userNotification = []; $userBuyCount = [];$total_icome = null;$sell_count_today = 0;
        $userBuy = [];$sell_rate = []; $sell_count_month = 0;
        $tenDay = [];
        $sellDay = []; $incomeDay = [];
        $sell_count_all = 0;
