        ...
        <form action="{{ route('settings.general.update')}}" method="POST" autocomplete="on"
          ...
          <div class="card" id="settings-card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Default Language')}}</label>
                <div class="col-sm-6 col-md-9">
                  <select class="form-control selectric" name="lang">
                    @foreach ($languages as  $language)
                        <option value="{{ $language->code }}" @if($setting['lang'] == $language->code) selected @endif >{{ $language->name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
        ...
        <form action="{{ route('settings.general.update2')}}" method="POST" autocomplete="on"
          ...
          <div class="card" id="settings-card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row align-items-center">
                ...
                <div class="col-sm-6 col-md-9">
                  <input type="password" autocomplete="current-password" name="imap_pass" class="form-control @error('imap_pass') is-invalid @enderror"
                    required value="{{ env('DEMO_MODE') ? "your password" : $setting['imap_pass'] }}">
                  @error('imap_pass')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
                  ...
                  <div class="col-sm-6 col-md-9 row">
                    ...
                    <div class="col-12 col-md-6">
                      <select class="form-control selectric" name="email_lifetime_type">
                        <option value="1440" {{ $setting['email_lifetime_type'] == '1440' ? 'selected' : '' }}>{{__('Days')}}</option>
                        <option value="60" {{ $setting['email_lifetime_type'] == '60' ? 'selected' : '' }}>{{__('Hours')}}</option>
                        <option value="1" {{ $setting['email_lifetime_type'] == '1' ? 'selected' : '' }}>{{__('Minutes')}}</option>
                      </select>
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('Recaptcha Site Key')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title"
                  class="form-control-label col-sm-3 text-md-right">{{__('Recaptcha Secret Key')}}</label>
                <div class="col-sm-6 col-md-9">
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Enable Cookie Pop Up')}}</label>
                <div class="col-sm-6 col-md-9">
                  <label class="custom-switch ">
                    <input type="checkbox" name="COOKIE_CONSENT_ENABLED" class="custom-switch-input" value="1"
              ...
              <div class="form-group row align-items-center">
                <label for="site-title" class="form-control-label col-sm-3 text-md-right">{{__('Force HTTPS')}}</label>
                <div class="col-sm-6 col-md-9">
                  <label class="custom-switch ">
                    <input type="checkbox" name="https_force" class="custom-switch-input" value="1"
                      @if($setting['https_force']) checked @endif>
                    <span class="custom-switch-indicator"></span>
                  </label>
                </div>
              </div>
