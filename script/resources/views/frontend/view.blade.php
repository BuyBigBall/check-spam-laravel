      ...
      <div class="col-md-8 col-sm-12">
        <div class="card mb-3">
          <div class="card-header">
            <div class="row">
              <div class="col-6 text-left"><a href="{{route('home') }}">{{__('Back To List')}}</a></div>
              <div class="col-6 text-right">
                @if (count($message['attachments']))
                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
                  aria-haspopup="true" aria-expanded="false">
                  <span class="d_show_line"><i class="fas fa-paperclip"></i></span><span class="d_hide">{{__('Attachments')}}</span>
                </a>
                ...
                @endif
                <a href="{{route('delete.message' ,$message['id'] ) }}">{{__('Delete')}}</a>
              </div>
            </div>
