                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <div id="hikashop_order_left_part" class="hikashop_order_left_part">Woobeo<br/>110 av. Barthelemy Buyer<br/>69009 Lyon<br/>France<br/><br/>VAT (TVA) : FR 52 809161177<br/>SIRET : 809 161 177 00013</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <fieldset class="adminform" id="htmlfieldset_products">
                                    ...
                                    <table cellpadding="1" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="hikashop_order_item_name_title title">Product</th>
                                                <th class="hikashop_order_item_price_title title">Unit price</th>
                                                <th class="hikashop_order_item_quantity_title title titletoggle">Quantity</th>
                                                <th class="hikashop_order_item_total_title title titletoggle">Price</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="row0">
                                                <td class="hikashop_order_item_name_value">
                                                    <a class="hikashop_order_product_link" href="{{ route('prices') }}">
                                                ...
                                                <td class="hikashop_order_item_price_value">50,00 €</td>
                                                <td class="hikashop_order_item_quantity_value">1</td>
                                                <td class="hikashop_order_item_total_value">50,00 €</td>
                                            </tr>
                                            <tr>
                                                <td style="border-top:2px solid #B8B8B8;" colspan="2"></td>
                                                <td class="hikashop_order_subtotal_title" style="border-top:2px solid #B8B8B8;">
                                                    <label>Subtotal</label>
                                                </td>
                                                <td class="hikashop_order_subtotal_value" style="border-top:2px solid #B8B8B8;">50,00 €</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"></td>
                                                ...
                                                <td class="hikashop_order_tax_value">10,50 €</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"></td>
                                                ...
                                                <td class="hikashop_order_total_value">60,50 €</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </fieldset>
