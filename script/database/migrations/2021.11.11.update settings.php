<?php
    # admin 127.0.0.1:8000/admin [tona@test.com : tonatest] #


    // UPDATE `settings` SET `value` = 'localhost' WHERE `id` = '8'; # domains
    // UPDATE `settings` SET `value` = 'localhost' WHERE `id` = '5'; # imap_host
    // UPDATE `settings` SET `value` = 'root' WHERE `id` = '6';      # imap_user
    // UPDATE `settings` SET `value` = 'password' WHERE `id` = '7';  # imap_pass
    // UPDATE `settings` SET `value` = 'yasha3651@mail.ru' WHERE `id` = '35';   # MAIL_FROM_ADDRESS
    // UPDATE `settings` SET `value` = '1' WHERE `id` = '17';         # enable_blog = 1
    
    
    # UPDATE `menus` SET `title` = 'Buy Now' , `url` = '/prices' WHERE `id` = '1';    # login url
