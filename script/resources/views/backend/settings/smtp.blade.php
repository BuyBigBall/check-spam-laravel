              ...
              <div class="form-group row align-items-center">
                ...
                <div class="col-sm-6 col-md-9">
                    <select class="form-control selectric" name="MAIL_ENCRYPTION" id="encryption">
                      <option value="null" {{ $setting['MAIL_ENCRYPTION'] == 'null' ? 'selected' : '' }}>{{__('None')}}</option>
                      <option value="ssl" {{ $setting['MAIL_ENCRYPTION'] == 'ssl' ? 'selected' : '' }}>{{__('SSL')}}</option>
                      <option value="tls" {{ $setting['MAIL_ENCRYPTION'] == 'tls' ? 'selected' : '' }}>{{__('TLS')}}</option>
                    </select>
